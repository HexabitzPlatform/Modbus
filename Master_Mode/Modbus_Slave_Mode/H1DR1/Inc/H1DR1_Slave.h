/*
    ...
    File Name     : Modmus.h
    Description   : Header file for Modbus slave module.
										RS-485 Serial Transceiver (MAX14840EASA+)
*/
	
/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef _H1DR1_SLAVE_H
#define _H1DR1_SLAVE_H
...
#define WATER_METER_RATIO      0.0001
#define WATERMETRE_NAME        1783
#define SLAVE_ADDRESS          6
#define METRE_SERIAL_NUMBER    10416094  //9EEFDE

#define NUMBER_OF_REGISTERS    100/*22*/        // 18 Read / Write   +  4 Read only

#define MyID                1
#define USB_Module          2
#define Options             0x00
#define RcvMessageMaxSize   24
...
/* EMS_Status Type Definition */  
typedef enum 
{
  Modmus_OK = 0,
	Modmus_ERR_UnknownMessage = 1,
	Modmus_ERR_WrongParams,
	Modmus_ERROR = 255
} Module_Status;
...
extern uint32_t remoteVar1;
extern uint32_t remoteVar2;
extern uint32_t remoteVar3;
extern uint32_t remoteVar4;
extern uint32_t remoteVar5;
extern uint32_t remoteVar6;
extern uint32_t remoteVar7;
extern uint32_t remoteVar8;
extern uint32_t remoteVar9;
