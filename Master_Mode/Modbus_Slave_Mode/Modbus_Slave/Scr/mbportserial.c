 ...
 *
 * $Id: mbportserial.c,v 1.1 2008-12-21 13:50:51 cwalter Exp $
 */
#include "main.h"
...
#define RS_485_UART_1_ENABLE_TX(  )     HAL_GPIO_WritePin(GPIOA, GPIO_PIN_12, GPIO_PIN_SET)

#define RS_485_UART_1_DISABLE_TX(  )     HAL_GPIO_WritePin(GPIOA, GPIO_PIN_12, GPIO_PIN_RESET)
                ...
                UCHAR ucDataBits, eMBSerialParity eParity, UCHAR ucStopBits, xMBHandle xMBMHdl)
{
    ...
    /* Added by Hexabitz EMS firmware */
		uint32_t BaudRate;
		uint32_t DataBits;
		uint32_t Parity;
		uint32_t StopBit;
